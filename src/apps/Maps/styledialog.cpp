...
StyleDialog::StyleDialog(QWidget *aParent, CartoType::Framework& aFramework,const std::string& aStyleSheet):
    QDialog(aParent),
    ...
    CartoType::String name = "edit the custom style sheet and apply it to ";
