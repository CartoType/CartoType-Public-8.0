...
/**
This CartoTypeCore-specific version of DBL_MAX is supplied to avoid the bug in
...
FindTextA or FindTextW, etc., which causes conflicts with CartoTypeCore functions of
the same names.
*/
#undef DrawText
#undef FindText
